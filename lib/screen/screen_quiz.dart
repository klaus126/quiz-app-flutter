...
import 'package:simple_quiz_app/screen/screen_home.dart';
import 'package:simple_quiz_app/screen/screen_result.dart';
import 'package:simple_quiz_app/widget/widget_candidate.dart';

class QuizScreen extends StatefulWidget {
  List<Quiz> quizes;
  QuizScreen({required this.quizes});
  @override
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: AutoSizeText(// text길이를 사이즈에 따라 자동으로 줄여주는 auto_size_text 패키지 필요.
              quiz.title, 
